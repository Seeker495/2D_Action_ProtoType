...
#region GAME_DATA_CONSTANTS
    ...
    // 遠距離カメラの視野
    public const float CAMERA_FAR_DISTANCE = 12.3f;
    // 中距離カメラの視野
    public const float CAMERA_MIDDLE_DISTANCE = 10.9f;
    // 近距離カメラの視野
    public const float CAMERA_NEAR_DISTANCE = 9.3f;
    // 範囲外のオブジェクトに対するカメラの距離
    public const float CAMERA_OUT_OF_RANGE_DISTANCE = CAMERA_FAR_DISTANCE + 1.0f;

    // カメラ距離変更速度
    public const float CAMERA_CHANGE_VELOCITY = 9.5f;
...
#region PLAYER_CONSTANTS
    ...
    #region ABOUT_MOVING
        ...
        // 通常移動速度
        public const float PLAYER_NORMAL_VELOCITY = 9.0f;
        // ダッシュの移動速度倍率
        public const float PLAYER_DASH_MULTIPLY = 1.6f;
        //// 高速移動時の移動速度
    ...
    #region ABOUT_ATTACK
        ...
        // 弓の攻撃間隔(フレーム数)
        public const int ATTACK_BOW_INTERVAL = 9;
        // 弓の攻撃威力
        public const float ATTACK_BOW_POWER = 5.0f;
        // 弓の移動速度
        public const float ATTACK_BOW_SPEED = 11.5f;
